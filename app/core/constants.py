...
MESSAGES: dict[str, dict[str, str]] = {
    "ERROR": {
        ...
        "GEMINI_CLIENT_NOT_INITIALIZED": "Client not initialized",
        "CLOUDFLARE_GATEWAY_NOT_INITIALIZED": "Cloudflare Gateway not initialized",
        ...
        "EVALUATION_PROMPT_SAVE_FAILED": "保存に失敗しました",
